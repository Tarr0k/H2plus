...
**Heutiger Stand (2026-06-30):** Nur Teach-&-Replay-Motion-Backend (TeachReplayPlanner) existiert; `PolicyInterface`, `ScriptedPolicy` und `GrootPolicy` sind noch nicht angelegt (Doc-only).
