...
Reale API (Humanoid, siehe docs/sdk_reference.md):
  ...
  - WICHTIG: Vor SDK-Steuerung muss der **Debug-Modus** an der Fernbedienung aktiv sein
    (L2+R2 aktivieren, L2+A bestätigen, L2+B Notfall-Damping) — sonst kollidiert die
    SDK-Vorgabe mit dem automatisch laufenden Motion-Control-Programm (Zittern).
  - Voraussetzung Plattform: **H2 EDU** (Standard-H2 erlaubt keine Secondary Development).
